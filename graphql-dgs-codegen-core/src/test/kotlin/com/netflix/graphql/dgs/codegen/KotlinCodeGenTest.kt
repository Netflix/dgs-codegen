...
class KotlinCodeGenTest {
    ...
    @Test
    fun `Generate a Data Class where all fields are not required to be initialized in the constructors and which properties are mutable`() {
        val schema = """
            type Query {
    ...
    @Test
    fun `Generate a Data Class where all fields are initialized in the constructors and which properties are immutable`() {
        val schema = """
            type Query {
                cars: [Car]
            }
