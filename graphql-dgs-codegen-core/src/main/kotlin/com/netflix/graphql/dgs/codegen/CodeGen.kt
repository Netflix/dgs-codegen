...
data class CodeGenResult(
    ...
    fun merge(current: CodeGenResult): CodeGenResult {
        val javaDataTypes = this.javaDataTypes.plus(current.javaDataTypes).distinct()
        val javaInterfaces = this.javaInterfaces.plus(current.javaInterfaces).distinct()
        val javaEnumTypes = this.javaEnumTypes.plus(current.javaEnumTypes).distinct()
        val javaDataFetchers = this.javaDataFetchers.plus(current.javaDataFetchers).distinct()
        val javaQueryTypes = this.javaQueryTypes.plus(current.javaQueryTypes).distinct()
        val clientProjections = this.clientProjections.plus(current.clientProjections).distinct()
        val javaConstants = this.javaConstants.plus(current.javaConstants).distinct()
        val kotlinDataTypes = this.kotlinDataTypes.plus(current.kotlinDataTypes).distinct()
        val kotlinInputTypes = this.kotlinInputTypes.plus(current.kotlinInputTypes).distinct()
        val kotlinInterfaces = this.kotlinInterfaces.plus(current.kotlinInterfaces).distinct()
        val kotlinEnumTypes = this.kotlinEnumTypes.plus(current.kotlinEnumTypes).distinct()
        val kotlinDataFetchers = this.kotlinDataFetchers.plus(current.kotlinDataFetchers).distinct()
        val kotlinConstants = this.kotlinConstants.plus(current.kotlinConstants).distinct()
        val kotlinClientTypes = this.kotlinClientTypes.plus(current.kotlinClientTypes).distinct()
