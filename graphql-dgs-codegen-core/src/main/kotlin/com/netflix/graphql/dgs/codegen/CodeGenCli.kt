...
class CodeGenCli : CliktCommand("Generate Java sources for SCHEMA file(s)") {
    ...
    private val output by option("--output-dir", "-o", help = "Output directory")
        .file(
            canBeFile = false,
            canBeDir = true,
        ).default(File("generated"))
    private val packageName by option("--package-name", "-p", help = "Package name for generated types")
    private val subPackageNameClient by option(
        "--sub-package-name-client",
        help = "Sub package name for generated client",
    ).default("client")
    private val subPackageNameDatafetchers by option(
        "--sub-package-name-datafetchers",
        help = "Sub package name for generated datafetchers",
    ...
    private val language by option("--language", "-l", help = "Output language")
        .choice("java", "kotlin", ignoreCase = true)
        .default("java")
    ...
    private val generateInterfaces by option(
        "--generate-interfaces",
        "-i",
        help = "Generate interfaces for data types",
    ).flag(default = false)
