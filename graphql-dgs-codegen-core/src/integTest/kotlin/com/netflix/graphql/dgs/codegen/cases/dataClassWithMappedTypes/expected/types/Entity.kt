...
@FasterxmlJacksonDatabindAnnotationJsonDeserialize(builder = Entity.Builder::class)
@ToolsJacksonDatabindAnnotationJsonDeserialize(builder = Entity.Builder::class)
public class Entity(
