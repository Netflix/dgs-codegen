...
public class QueryProjection(
  ...
  public fun u(_alias: String? = null, _projection: UProjection.() -> UProjection): QueryProjection {
    field(_alias, "u", UProjection(inputValueSerializer), _projection)
    return this
  }

  public fun us(_alias: String? = null, _projection: UProjection.() -> UProjection): QueryProjection {
