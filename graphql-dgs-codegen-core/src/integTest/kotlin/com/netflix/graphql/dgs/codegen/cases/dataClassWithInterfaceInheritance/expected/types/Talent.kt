...
@FasterxmlJacksonDatabindAnnotationJsonDeserialize(builder = Talent.Builder::class)
@ToolsJacksonDatabindAnnotationJsonDeserialize(builder = Talent.Builder::class)
public class Talent(
