...
public class MyType(
    ...
    public companion object {
        private val countDefault: () -> List<Int>? = { throw IllegalStateException("Field `count` was not requested") }

        private val truthDefault: () -> List<Boolean>? = { throw IllegalStateException("Field `truth` was not requested") }

        private val floatyDefault: () -> List<Double>? = { throw IllegalStateException("Field `floaty` was not requested") }
    }
