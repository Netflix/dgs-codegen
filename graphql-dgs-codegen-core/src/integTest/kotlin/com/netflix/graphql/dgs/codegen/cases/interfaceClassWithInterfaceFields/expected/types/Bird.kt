...
public class Bird(
  ...
  override fun equals(other: Any?): Boolean = this === other || (other is Bird && `__$fieldValues`()
  ...
  override fun toString(): String = `__$fieldStrings`().joinToString(prefix = "Bird(", postfix =
      ")")
