...
public class Q1GraphQLQuery extends GraphQLQuery {
  ...
  public static class Builder {
    ...
    public Q1GraphQLQuery build() {
      return new Q1GraphQLQuery(arg1, arg2, queryName, fieldsSet, variableReferences, variableDefinitions);
    ...
    public Builder arg2Reference(String variableRef) {
      ...
      this.variableDefinitions.add(graphql.language.VariableDefinition.newVariableDefinition(variableRef, new graphql.language.TypeName("I2")).build());
      this.fieldsSet.add("arg2");
      return this;
    }
